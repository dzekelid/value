...
created: "2018-06-20"
modified: "2018-06-20"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/value/master/_listings/square/apis.md
...
- name: Square Connect API Deletes a timecard. Deleted timecards are still accessible
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/value/master/_listings/square/v1metimecardstimecard-id-delete-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/value/master/_listings/square/v1metimecardstimecard-id-delete-openapi.md
- name: Square Connect API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/value/master/_listings/square/openapi.md
x-common:
- type: x-base
